...
function Form() {
  ...
  const sendEmail = (obj) => {
    setLoad(true);
    emailjs.init({
      publicKey: "RcW0-KmcliZvnFFsU", // must add public key and connect your gmail with email.js
      blockHeadless: true,
      blockList: {
    ...
    emailjs
      .send("service_bhl55fv", "template_zas4wej", obj)  //  add your service key and template id
      .then((response) => {
