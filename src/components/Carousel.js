...
export default function HomeCarousel({scrollFunction}) {
        ...
        <div className="mx-auto px-6 grid grid-cols-1 md:grid-cols-5 relative py-16">
          <div className="flex flex-col relative z-20 col-span-1 md:col-span-3 slide-right">
            ...
            <div className="flex mt-8">
              <div className="uppercase py-2 px-4 rounded-lg bg-custom-500 border-2 border-transparent text-white text-md mr-4 hover:bg-custom-300 cursor-pointer" onClick={() => {
                  foo("contact");
                }}>
                Contact me
              </div>
          ...
          <div className="hidden md:flex relative col-span-2 slide-left">
            <img src="/logoImage.jfif" className="mx-auto ml-0 rounded-full" />
          </div>
        </div>
      </div>
    </main>
